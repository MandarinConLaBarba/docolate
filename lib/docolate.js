...
Docolate.prototype.render = function(templatePath) {
    ...
    templatePath = templatePath || this.templates.html;
    var docolate = this;
...
Docolate.prototype.route = function(outputFormat, outputTemplate) {
    ...
    if (outputFormat === 'markdown') {
        ...
        outputTemplate = outputTemplate || this.templates.markdown;
        ...
        outputTemplate = outputTemplate || this.templates.html;
...
module.exports = Docolate;

Docolate.create = function(app, options) {
